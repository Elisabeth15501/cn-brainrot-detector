...
const DICT = [
  ...
  /* —— B站 2024-2026 新烂梗（空耳梗、小学生烂梗、抽象梗） —— */
  {t:"哈基米",p:"可爱的猫咪 / 萌宠",e:"萌宠 / 可爱生灵",n:"赛马娘空耳「ハチミツ」(蜂蜜) 经B站二次传播成猫咪代称，现泛滥用于一切可爱事物",
   amb:true, ex:[/哈基米.{0,6}?(?:赛马|马娘|蜂蜜|蜜|ハチミツ|运动番|主题曲|OP)/,/哈基米[（(]?(?:歌曲|番|MV|片|视频)/]},
  {t:"我要验牌",p:"（无意义空耳句）",e:"（无意义）",n:"周星驰《赌侠Ⅱ》台词「我要验牌」空耳梗，2026 开年爆火，纯噪音梗，无实际语义"},
  {t:"阿玛特拉斯",p:"（无意义中二词）",e:"（无意义）",n:"动漫《火影忍者》写轮眼技能「月读·阿玛特拉斯」的滥用，中二烂梗，正文字面无意义"},
  {t:"爱你老己",p:"爱你自己",e:"珍重己身 / 自重自爱",n:"「爱你自己」谐音变体，2025 年末 B站流行卖萌音梗，过度使用即成烂梗"},
  {t:"丝瓜汤",p:"（无意义敷衍回复）",e:"（无意义）",n:"短剧梗「来喝杯丝瓜汤」，表示无效沟通/糊弄回应，现已泛化为无意义语气词",
   amb:true, ex:[/丝瓜汤(?:的|[？?]?)?(?:菜谱|做法|怎么|如何|好吃|教程|营养|减肥|瘦身|做法|步骤|视频)/]},
  {t:"受着",p:"忍着 / 接受",e:"忍辱负重 / 甘之如饴",n:"小学生烂梗「有本事你受着」，怼人式敷衍，说「忍着」即可",
   amb:true, ex:[/受着[！!]?(?:吧|了|吗|嘛|你的|他的)/,/忍辱负重|委曲求全|含垢匿瑕|默默承受|甘愿受着/]},
  {t:"又能怎",p:"又能怎么样",e:"无可奈何 / 事已至此",n:"小学生烂梗「又能怎样呢」缩略，怼人式敷衍，说「没办法」更清楚"},
  {t:"因为我善",p:"因为我是好人 / 出于善意",e:"怀仁抱义 / 心存善意",n:"「因为我善良」缩略，摆烂借口梗，常用来为自己的不当行为开脱"},
  {t:"演都不演了",p:"不再掩饰了",e:"不加粉饰 / 直言其事",n:"「连演都懒得演了」缩略，滥用于轻微场景，说「不掩饰了」更直接"},
  {t:"菜就多练",p:"技术差就多练习",e:"勤能补拙 / 勉力进修",n:"游戏圈嘲讽烂梗，用来贬低他人技术，说「要多练习」更得体"},
  {t:"曼波",p:"（无意义拟声）",e:"（无意义）",n:"「哈基米」配套空耳梗，「曼波~」模仿节奏感，无实际语义，正文字面无意义"},
  /* —— 残障/精神疾病污名化梗 —— */
  ...
  {t:"娘",p:"（贬损男性气质）",e:"（无意义）",n:"「娘」本意为母亲，现被部分网友用作对男性气质的贬损称呼（「娘炮」「娘娘腔」），将女性特质当作嘲笑武器，官媒批评此类用语加剧性别对立",
   amb:true, ex:[/娘[亲爹母子奶奶外公外婆祖父祖母爷爷父亲母亲爸爸妈妈]/,/赛马娘/,/娘娘(?:宫|庙|太后|妃|驾|寿|征|番|传|曲|腔|店|超市|面包|蛋糕|酥|糕|饼|卷|冰淇淋|茶|奶|啡|糖|霜|脂|粉|油|烛|皂|洗|护|露|水|乳液)/,/老娘|娘们|娘家|娘舅|娘亲|慈母|孟母|岳母|丈母娘|后妈|继母|养娘|丫鬟|婢娘|使女|女仆|保姆|月嫂|护工|助产|接生|催生|保胎|安胎|孕产|妇产|儿科|产科|婴幼|育婴|早教|托儿|幼儿园|小学|中学|大学|学院|教授|讲师|老师|教师|园丁|桃李|春风|化雨|润物|无声|蜡烛|春蚕|丝尽|泪干|成灰|始已/]},
